  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="{{ url('/') }}" class="logo d-flex align-items-center">
        ...
        <img src="landingpage/assets/img/logo-word.png" alt="">
      </a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Welcome to Mr.Books!</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Traveling through reading and make your brighter future with us! Let us bring you to the magical land!</h2>
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="landingpage/assets/img/hero-img.svg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
